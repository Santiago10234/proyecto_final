  ...
  return (
    <div>
        <div className="card-group" style={{display:'flex', justifyContent:'space-evenly', marginLeft:'60px', marginRight:'60px'}}>
            <div style={{border:'1px solid silver', borderRadius:'20px', padding:'6px',  transition: 'transform 0.3s ease', cursor:'pointer'}}   onMouseEnter={e => e.currentTarget.style.transform = 'scale(1.15)'} onMouseLeave={e => e.currentTarget.style.transform = 'scale(1)'}>
